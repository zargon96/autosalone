...
const getLogo = (brand) => `${LOGO_URL}/logo-${brand}.webp`;
...
export const cars = {
  ...
  honda_s2000: {
    ...
    name: "Honda S2000",
    logo: getLogo("honda"),
    model: `${BASE_URL}/honda_s2000_opt.glb`,
    scale: 110,
    rotation: [0, -0.4, 0],
    offset: [0, -0.5, 0],
    stats: {
  ...
  ferrari_enzo: {
    ...
    name: "Ferrari Enzo",
    logo: getLogo("ferrari"),
    model: `${BASE_URL}/ferrari_enzo_opt.glb`,
    scale: 110,
    rotation: [0, -0.4, 0],
    offset: [0, -0.5, 0],
    stats: {
  ...
  lancia_delta_integrale: {
    ...
    logo: getLogo("lancia"),
    model: `${BASE_URL}/lancia_delta_opt.glb`,
    scale: 110,
    rotation: [0, -0.4, 0],
    offset: [0, -0.5, 0],
    stats: {
  ...
  lamborghini_diablo: {
    ...
    logo: getLogo("lamborghini"),
    model: `${BASE_URL}/lamborghini_diablo_opt.glb`,
    scale: 110,
    rotation: [0, -0.4, 0],
    offset: [0, -0.5, 0],
    stats: {
  ...
  honda_nsx: {
    ...
    name: "Honda NSX",
    logo: getLogo("honda"),
    model: `${BASE_URL}/honda_nsx_opt.glb`,
    scale: 110,
    rotation: [0, -0.4, 0],
    offset: [0, -0.5, 0],
    stats: {
  ...
  f12: {
    ...
    logo: getLogo("ferrari"),
    model: `${BASE_URL}/ferrari_f12_opt.glb`,
    scale: 100,
    rotation: [0, -0.4, 0],
    offset: [0, -0.5, 0],
    stats: {
  ...
  z350: {
    ...
    name: "Nissan 350Z",
    logo: getLogo("nissan"),
    model: `${BASE_URL}/nissan_350z_opt.glb`,
    scale: 104,
    rotation: [0, -0.4, 0],
    offset: [0, -0.5, 0],
  ...
  rx7_fd: {
    ...
    name: "Mazda RX-7",
    logo: getLogo("mazda"),
    model: `${BASE_URL}/mazda_rx7_opt.glb`,
    scale: 0.4,
    rotation: [0, -0.4, 0],
    offset: [0, -0.5, 0],
    stats: {
